            ...
            <div class="bd-example">
                <div id="carouselOne" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item bg_cover active" style="background-image: url(<?=base_url('assets/images/banner/banner.png');?>)">
                        ...
                        <div class="carousel-item bg_cover" style="background-image: url(<?=base_url('assets/images/banner/banner.png');?>)">
                            <div class="carousel-caption">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-xl-6 col-lg-7 col-sm-10">
